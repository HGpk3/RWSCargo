...
const dictionary: Record<string, Translation> = {
  ...
  "Оформить заявку": { en: "Submit request", zh: "提交申请" },
  "Калькулятор доставки": { en: "Delivery calculator", zh: "运输计算器" },
  "Получить бесплатный расчёт": { en: "Get a free quote", zh: "获取免费报价" },
  ...
  "рассчитать маршрут": { en: "calculate route", zh: "计算路线" },
  ...
  "Переговоры и проверка поставщика": { en: "Supplier negotiations and check", zh: "供应商谈判与核查" },
  ...
  "Рассчитать услугу": { en: "Calculate service", zh: "计算服务" },
  "Обсудить сценарий": { en: "Discuss scenario", zh: "讨论方案" },
  "Рассчитать сценарий": { en: "Calculate scenario", zh: "计算方案" },
  ...
  "Рассчитать регулярную поставку": { en: "Calculate regular shipment", zh: "计算长期供货" },
...
Object.assign(dictionary, {
  ...
  "Партия для своего магазина": { en: "Shipment for your own store", zh: "自有店铺货物" },
  ...
  "Любые товары, кроме запрещённых к ввозу. Чаще всего работаем с маркетплейсами, электроникой, одеждой, мебелью, оборудованием, автозапчастями, сборными и контейнерными грузами.": {
    en: "Any goods except those prohibited for import. Most often we work with marketplace goods, electronics, clothing, furniture, equipment, auto parts, consolidated and container cargo.",
    zh: "除禁止进口商品外均可。常见品类包括电商商品、电子、服装、家具、设备、汽车配件、拼货和集装箱货物。",
  },
