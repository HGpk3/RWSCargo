...
const formats = [
  {
    ...
    title: "С документами для ВЭД и бухгалтерии",
    desc: "Контрактная часть, инвойсы, упаковочные листы, закрывающие документы и понятная ответственность по этапам.",
  },
  {
    tag: "ЭКОНОМИЧНЫЙ ФОРМАТ",
    title: "Для маркетплейсов и пополнения склада",
    desc: "Быстрая коммерческая поставка, когда важнее скорость, себестоимость, консолидация и регулярное движение партии.",
  },
  {
    tag: "ПОДБОР СХЕМЫ",
    title: "Когда формат ещё не очевиден",
    desc: "Разбираем товар, поставщика, объём, риски и сроки, а потом предлагаем рабочий маршрут и следующий шаг.",
  },
];
