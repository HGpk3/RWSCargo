...
const services = [
  {
    ...
    desc: "Подбираем производителей под товар, запрашиваем реальные фото и видео, проверяем образцы, сравниваем предложения и добиваемся снижения цены.",
    bullets: ["фабрики и альтернативные поставщики", "снижение цены, MOQ и сроки производства", "брендирование и упаковка"],
  },
  {
    id: "service-purchase",
    n: "03",
  ...
  },
  {
    ...
    desc: "Для коммерческих партий заранее проверяем документы, формат ввоза и требования к товару. Готовим контрактную часть, инвойс, упаковочный лист и документы, необходимые для таможенного оформления.",
    bullets: ["ДОКУМЕНТЫ ПРОВЕРЯЕМ ДО ОТПРАВКИ", "ПОНЯТНАЯ ОТВЕТСТВЕННОСТЬ", "ДОКУМЕНТЫ ДЛЯ БУХГАЛТЕРИИ"],
  },
  {
    id: "service-negotiation",
    n: "06",
    title: "Переговоры и проверка поставщика",
    desc: "Ведём коммуникацию с китайским поставщиком, согласовываем цену, сроки, условия производства и доработки. Фиксируем ключевые договорённости и контролируем спорные моменты.",
    bullets: ["ПЕРЕВОД БЕЗ ПОТЕРИ СМЫСЛА", "СОГЛАСОВАНИЕ УСЛОВИЙ", "КОНТРОЛЬ ДОГОВОРЁННОСТЕЙ"],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 inline-flex items-center gap-1" style={{ color: BRAND, fontSize: 13, fontWeight: 500 }}>
        Рассчитать услугу <ArrowUpRight size={13} />
      </div>
    </a>
  );
}
